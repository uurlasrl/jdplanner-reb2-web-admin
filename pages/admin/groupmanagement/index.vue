<template>
  <div>
    <NewRole modal-name="newrole" @onrolesubmit="onNewRoleSubmit($event)"></NewRole>
    <UserList modal-name="newuser" @onSelectUser="onNewUserSubmit($event)"></UserList>
    <b-container fluid>
      ...
      <b-row>
        <b-col>
          <b-button-group>
            ...
            <b-button @click="$bvModal.show('newrole')"><b-icon icon="file-earmark-plus"></b-icon> {{ $t('btnNew')}}</b-button>
          </b-button-group>
        </b-col>
...
import NewRole from '@/components/createnew/NewRole'
