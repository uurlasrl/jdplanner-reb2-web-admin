...
<!--                </b-col>-->
            ...
            <b-button type="submit" class="btn btn-block"  :disabled="$v.form.$anyError" variant="primary">{{ $t('btnChgpassword') }}</b-button>
            <hr>
            <b-button type="submit" class="btn btn-block btn-danger" @click.prevent="$emit('DoLogout')" variant="primary"><b-icon icon="power" aria-hidden="true"></b-icon>  {{ $t('btnLogout') }}</b-button>
          </b-form>
          <b-container>
            <b-row>
